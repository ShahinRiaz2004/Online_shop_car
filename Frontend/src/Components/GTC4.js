    ...
    return (
      ...
      <div>
          <div className='div-Go1a' style={{position:'relative',top:'450px',alignItems:'center',fontSize:'22px',color:'white'}}>
              <div><span> 118 mph (450 km/h) </span><span> |</span>
              <span> 2 seater </span><span> |</span>
              <span> 1-62-mph in 4.8 sec </span>
          </div>
          </div>
          <div className='div-Go1b' style={{position:'relative',top:'460px',alignItems:'center',fontSize:'12px',color:'white',left:'20px'}}>
              <div><span>45 units capacity</span> <span></span><span> | </span>
              <span> len-3456mm | wid-2290mm </span><span>|</span>
              <span> Horsepower: 378 to 766 kW</span>
          </div>
          </div>
        <span className='Gospan'>
          ...
          <li> Boot Space (Litres) - 710</li>
          <li> Fuel Tank Capacity - 100</li>
